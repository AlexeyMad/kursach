    ...
    <body>
                                    ...
                                    <form class="form-horizontal" action="#" method="post" enctype="multipart/form-data">
                                      <fieldset>
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input type="text" class="span6" name="title" id="typeahead" required>
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
											...
											<option value=""></option>
											  ...
											  {
		 echo '<option value="'.$selectcatarray['service_id'].'">'.$selectcatarray['service_name'].'</option>';
											  }
											  ?>
                                            </select>
                                          </div>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input type="text" class="span6" name="client_name" id="typeahead" required>
       ...
       <input class="input-file uniform_on" id="fileInput" type="file" name="file" >
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
      <textarea name="description" cols="40" rows="5" class="input-xlarge textarea" placeholder="Enter text ..." style="width: 810px; height: 200px"></textarea>
                                          </div>
                                        </div>
...
$insertportfolio=mysql_query("insert into `portfolio` values('','$title','$place_file','$description','$client_name','$date','$webservices')");
if($insertportfolio)
{
echo"
<script>
$(function() {
$.jGrowl('Portfolio added successfully', { header: 'Portfolio' });
});
</script>
";
echo "<script>
